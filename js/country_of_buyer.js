...
//value  可控制光点大小
var BJData = [
    [{name:'中国'}, {name:'日本',value:60}],
    [{name:'中国'}, {name:'印度',value:60}],
    [{name:'中国'}, {name:'澳大利亚',value:60}],
    [{name:'中国'}, {name:'马来西亚',value:60}],
    [{name:'中国'}, {name:'俄罗斯',value:60}],
    [{name:'中国'}, {name:'美国',value:60}],
    [{name:'中国'}, {name:'墨西哥',value:60}],
    [{name:'中国'}, {name:'巴西',value:60}],
    [{name:'中国'}, {name:'西班牙',value:60}],
    [{name:'中国'}, {name:'法国',value:60}],
    [{name:'中国'}, {name:'德国',value:60}],
    [{name:'中国'}, {name:'英国',value:60}],
    [{name:'中国'}, {name:'意大利',value:60}],
    [{name:'中国'}, {name:'中国',value:60}],
    [{name:'中国'}, {name:'韩国',value:60}],
];
var RBData = [
